...
class DecimalToWordsConverter {
    ...
    public synchronized static DecimalToWordsConverter getInstance() {
        if (DecimalToWordsConverter.instance == null) {
            DecimalToWordsConverter.instance = new DecimalToWordsConverter();
        }
    ...
    private IntegerInWords convertLeftNumber(String leftNumber) {
        ...
        number = this.converter.convert(Long.parseLong(leftNumber));
    ...
    private IntegerInWords convertRightNumber(String rightNumber) {
        ...
        IntegerInWords number = this.converter.convert(Long.parseLong("-" + rightNumber));
